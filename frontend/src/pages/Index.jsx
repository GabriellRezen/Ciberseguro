...
import { BookOpen, Search, AlertTriangle, Shield, ArrowRight, Users, Eye, MessageSquareWarning } from "lucide-react";
  ...
  return (
    <div className="min-h-screen">
          ...
          <div className="grid md:grid-cols-2 gap-10 items-center">
            ...
            >
              <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-primary-foreground/10 border border-primary-foreground/20 mb-6">
                ...
                <span className="text-xs font-medium text-primary-foreground/80">Plataforma oficial PSP</span>
              </div>
      ...
      <section className="container py-16">
        ...
        >
          <h2 className="text-2xl md:text-3xl font-bold text-foreground mb-2">Como podemos ajudar?</h2>
          <p className="text-muted-foreground">Escolha a opção que melhor se aplica à sua situação</p>
        </motion.div>
      ...
      <section className="bg-card border-y border-border">
        <div className="container py-16">
          <motion.div
            ...
            className="text-center mb-10"
          >
            <h2 className="text-2xl md:text-3xl font-bold text-foreground mb-2">Tipos de ciberbullying</h2>
            <p className="text-muted-foreground">Conheça as formas mais comuns de agressão online</p>
          </motion.div>

          <div className="grid md:grid-cols-3 gap-5 max-w-4xl mx-auto">
            {[
              { icon: MessageSquareWarning, title: "Insultos e humilhação", desc: "Mensagens ofensivas, comentários depreciativos ou ridicularização pública." },
              { icon: AlertTriangle, title: "Ameaças e intimidação", desc: "Mensagens ameaçadoras, chantagem emocional ou coerção online." },
              { icon: Eye, title: "Exposição e partilha", desc: "Divulgação de fotos, vídeos ou informações pessoais sem consentimento." },
            ].map((type, i) => (
              <motion.div
                key={i}
                initial={{ opacity: 0, y: 20 }}
      ...
      <footer className="border-t border-border bg-card">
        <div className="container py-8 text-center">
          <div className="flex items-center justify-center gap-2 mb-3">
            ...
            <span className="text-sm font-semibold text-foreground">CiberSeguro</span>
          </div>
