            ...
            {!showResult ? (
              ...
              >
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                    {quickButtons.map((btn) => (
                      <motion.button
                        ...
                        disabled={loading}
                        className="flex items-center gap-3 p-4 rounded-xl border border-border bg-card hover:border-secondary/30 transition-all text-left disabled:opacity-60"
                      >
                ...
                <div className="bg-card rounded-xl border border-border p-5">
                  <textarea
                    ...
                    className="w-full min-h-[120px] bg-transparent text-sm text-foreground placeholder:text-muted-foreground resize-none outline-none"
                  />
                  ...
                  <div className="flex items-center justify-between mt-4 pt-4 border-t border-border gap-3 flex-wrap">
                    ...
                    <motion.button
                      ...
                      className="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg bg-secondary text-secondary-foreground font-semibold text-sm disabled:opacity-40 disabled:cursor-not-allowed hover:bg-secondary/90 transition-colors"
                    >
                      {loading ? (
              ...
              >
                ...
                <div className="flex flex-wrap gap-3">
                  ...
                  <button
                    onClick={reset}
                    className="px-5 py-3 rounded-xl text-muted-foreground font-medium text-sm hover:text-foreground transition-colors"
                  >
                    Nova análise
                  </button>
                </div>
